...
This is a simple mod project template for Survivalcraft API 1.80 这是一个适用于生存战争 API 1.80 的简单模组示例项目

If you want to replace the API version to 1.8.1.2, you can open the `.csproj` file and replace all `1.8.0` to `1.8.1.2`.
如果要适配 API 1.8.1.2，只需要把`.csproj`文件中出现的`1.8.0`修改为`1.8.1.2` 即可
